...
public class PojoReporteGeneral {
    ...
    public String getNombreCampoCarrera() {
        return nombreCampoCarrera;
    }

    public void setNombreCampoCarrera(String nombreCampoCarrera) {
        this.nombreCampoCarrera = nombreCampoCarrera;
    }
